                            ...
                            <table id="datable_2" class="table table-striped" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th width='10%'>SKS</th>
                                        <th width='10%'>Rumus Perhitungan</th>
                        ...
                        <form id="form">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <!-- Material input -->
                                    <div class="md-form form-group">
                                        <input type="text" class="form-control" id="detail" name="detail" placeholder="Detail Rubrik">
                                        <label for="detail">Detail Rubrik</label>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <!-- Material input -->
                                    <div class="md-form form-group">
                                        <input type="text" class="form-control" id="rumus" name="rumus" placeholder="Rumus Pehitungan">
                                        <label for="rumus">Rumus Pehitungan</label>
                                    </div>
                                </div>
                            </div>
                            <div class="form-row">
...
<script type="text/javascript">
    ...
    function edit(kd_form) {
        ...
        $.ajax({
            ...
            dataType: "json",
            data: ({
                tabel: 'mst_rubrik_penunjang',
                kd_form,
                where: 'id_rubrik'
            }),
            url: "master-penunjang-detail.html",
    ...
    function simpan1() {
        ...
        if ($('#detail').val() == "") {
            swal('Gagal', 'Detail Rubrik masih kosong', "error");
            return false;
        }
        if ($('#sks').val() == "") {
        ...
        if ($('#jabatan').val() == "") {
            swal('Gagal', 'Jabatan masih kosong', "error");
            return false;
        }
